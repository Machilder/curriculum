...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected static final String CONST_ELEMENT_NAME_REQUEST = "employee";
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            EmployeeBean setEmployeeBean = new EmployeeBean();
            setEmployeeBean = null;
            
            //Tips1
            setEmployeeBean.setEmpId(reqEmpId);
            setEmployeeBean.setPassword(reqPassword);
            
            //Tips2
            responseBean = this.ems.getEmployeeData(ExecuteCase.FIND_BY_EMPID,setEmployeeBean);
